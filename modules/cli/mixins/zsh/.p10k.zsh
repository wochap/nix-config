...
# Generated by Powerlevel10k configuration wizard on 2023-12-16 at 01:34 EST.
...
() {
  ...
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_SUFFIX='%F{#cba6f7}─╮'
  typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_SUFFIX='%F{#cba6f7}─┤'
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_SUFFIX='%F{#cba6f7}─╯'
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local       meta='%13F%B'     # default foreground
      ...
      local       meta='%13F'  # grey foreground
      local      clean='%13F'  # grey foreground
      local   modified='%13F'  # grey foreground
      local  untracked='%13F'  # grey foreground
      local conflicted='%13F'  # grey foreground
    fi
    ...
    typeset -g my_git_format="$res%f%b"
  }
  ...
  typeset -g POWERLEVEL9K_VI_COMMAND_MODE_STRING="%B NOR %b"
  typeset -g POWERLEVEL9K_VI_MODE_NORMAL_BACKGROUND="#b4befe"
  # Text and color for visual vi mode.
  typeset -g POWERLEVEL9K_VI_VISUAL_MODE_STRING="%B VIS %b"
  typeset -g POWERLEVEL9K_VI_MODE_VISUAL_BACKGROUND="#f2cdcd"
  # Text and color for overtype (a.k.a. overwrite and replace) vi mode.
  typeset -g POWERLEVEL9K_VI_OVERWRITE_MODE_STRING="%B REP %b"
  typeset -g POWERLEVEL9K_VI_MODE_OVERWRITE_BACKGROUND=3
  # Text and color for insert vi mode.
  typeset -g POWERLEVEL9K_VI_INSERT_MODE_STRING="%B INS %b"
