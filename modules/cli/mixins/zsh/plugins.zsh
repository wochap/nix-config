...
function _zsh_autocomplete_atinit() {
...
function _zsh_autocomplete_atload() {
...
zinit ice lucid wait \
  atload"_zsh_autocomplete_atload" \
  atinit"_zsh_autocomplete_atinit" \
  depth"1" src"zsh-autocomplete.plugin.zsh"
zinit light wochap/zsh-autocomplete

## zsh-autosuggestions

function _zsh_autosuggestions_start() {
  export ZSH_AUTOSUGGEST_MANUAL_REBIND=true
  export ZSH_AUTOSUGGEST_STRATEGY=(history completion)

  zinit ice lucid wait \
    atload"_zsh_autosuggest_start; _zsh_autosuggest_fetch" \
...
function _zsh_history_substring_search_start() {
  zinit ice lucid wait \
...
zinit ice lucid wait \
  ...
  atload"fast-theme XDG:catppuccin-mocha --quiet; _zsh_history_substring_search_start" \
...
zinit ice lucid wait \
  atload"_zsh_fzf_start; load_key_bindings" \
