...
in {
  options._custom.desktop.udev-rules = {
    enable = lib.mkEnableOption { };
    canDisableGlegionKbd = lib.mkEnableOption { };
  };
  ...
  config = lib.mkIf cfg.enable {
    ...
    systemd.services.cornekbd-disable-glegion-builtin-kbd =
      lib.mkIf cfg.canDisableGlegionKbd {
    ...
    systemd.services.chocofikbd-disable-glegion-builtin-kbd =
      lib.mkIf cfg.canDisableGlegionKbd {
        description =
          "Disable glegion builtin kbd when Chocofi kbd is connected";
