...
tmux set-option -g status-right "#[bg=default,fg=${lavender}]${user_module}${host_module}#{?client_prefix,prefix ,}#{?window_zoomed_flag,${layout_icon_by_name["zoom"]} zoom ,}#[bg=default,fg=${surface1}]${windows_icon} #{window_panes} ${session_icon} #S "
