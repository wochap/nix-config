...
# args passed to tmux-tab-name: path, command, pane_title, host, window count
tab_args="\"#{pane_current_path}\" \"#{pane_current_command}\" \"#{pane_title}\" \"#{host}\" \"#{session_windows}\""
...
tmux set-option -g automatic-rename-format "#(tmux-tab-name active ${tab_args})"
