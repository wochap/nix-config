{
  inputs = {
    ...
    scenefx.url = "github:wlrfx/scenefx?rev=ae7baccb4c962b00d9ef2c3515f8820d17f55ddc"; # main (10 jan 2024)
    ...
    reversal-extra.url = "github:wochap/Reversal-Extra?rev=c172ffa68af881fbc287db706d4fa263ddc70ec5";
