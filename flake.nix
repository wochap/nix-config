{
  inputs = {
    # channels
    unstable.url = "github:nixos/nixpkgs?rev=57610d2f8f0937f39dbd72251e9614b1561942d8"; # nixos-unstable (jun 03 2024)
    ...
    reversal-extra.url = "github:wochap/Reversal-Extra?rev=3655f14ca4ded4ebd76b97c84133793e4b8215b6";
